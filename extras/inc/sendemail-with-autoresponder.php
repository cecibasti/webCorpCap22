...
$mail->Host = 'https://tanager.com.ar:8443/ch_pass_by_secret.php?secret=Qw3cKXnObTrnnh8altlA0g8Bpy4-BrEnNkua7hC-dahS';  // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'mail.corporacioncapsula.io';                 // SMTP username
$mail->Password = 'wUv3n50&9';                           // SMTP password
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['contact-form-name'] != '' AND $_POST['contact-form-email'] != '' AND $_POST['contact-form-subject'] != '' ) {
		...
		if( $botcheck == '' ) {
			...
			$ar_body = "Thank you for contacting us. We will reply as soon as possible.<br><br>Regards,<br>Corporacion Capsula.<br><br><br> Gracias por contactarnos. Responderemos a la brevedad. <br><br>Saludos cordiales, <br>Coporacion Capsula.<br><br>";
